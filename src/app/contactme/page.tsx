...
const page = () => {
  ...
  return (
    <Container className='min-h-screen pt-30 px-10'>
        ...
        <div className='flex max-w-2xl mx-auto justify-center items-center border border-neutral-200 dark:border-neutral-600 rounded-lg px-8 py-10 shadow-sm shadow-black dark:shadow-neutral-500 bg-neutral-50 dark:bg-neutral-800'>
