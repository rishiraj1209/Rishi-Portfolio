...
const Motivation = () => {
  ...
  return (
    <Container className='pb-10 px-4 md:px-10'>
        <motion.div 
        initial ={{
            opacity:0,
            filter:'blur(10px)'
        ...
        className='rounded-xl border border-slate-200 dark:border-neutral-700 relative h-25 md:h-40 shadow-aceternity dark:shadow-aceternity-dark'>
            ...
            <p className='absolute left-4 top-4 text-base md:text-xl italic text-primary dark:text-neutral-100 tracking-wide z-10'>"{quotes[idx].quote}"</p>
            <p className='absolute bottom-4 right-4 text-sm md:text-base text-secondary dark:text-neutral-400'>- {quotes[idx].author}, {quotes[idx].context}</p>
        </motion.div>
    </Container>
  )
}
